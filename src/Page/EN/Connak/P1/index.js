                ...
                <div className="row text-center mb-4">
                  <div className="col-md-6">
                    <div className="p-3 border rounded shadow-sm" style={{ backgroundColor: '#f8f9fa' }}>
                      <p className="fw-bold">Share Registration and Investor Relations<br />Managing Director's Office</p>
                      <p>Phone Number: 0-2420-0076 ext 359<br />email: <a href="mailto:omd_ir@thairung.co.th">omd_ir@thairung.co.th</a></p>
                  </div>
                  </div>
                  <div className="col-md-6">
                    <div className="p-3 border rounded shadow-sm" style={{ backgroundColor: '#f8f9fa' }}>
                      <p className="fw-bold">Ms. Nayana Prachoti Rattanakul<br />Assistant General Manager</p>
                      <p>Phone Number: 0-2420-0076 ext 321<br />email: <a href="mailto:naiyana@thairung.co.th">naiyana@thairung.co.th</a></p>
                    </div>
                  </div>
                </div>
              </div>
