    ...
    <div>
      ...
      >
        ...
        >
          ...
          >
           Proposed Agenda for the General Meeting of Shareholders
           and Director for the year 2025
          </button>
          <button
            type="button"
        ...
        <div className="col-lg-6 col-md-6" key={agenda.id}>
          ...
          >
            ...
            >
              ...
              <a
                href={`${process.env.REACT_APP_PDF_KEY}/uploads/pdf_files/${agenda.pdf_url_en}`}
                target="_blank"
              ...
              {loading ? (
                ...
                data.map((item) => (
                  <div
                    ...
                    onClick={() =>
                      window.open(`${process.env.REACT_APP_PDF_KEY}/uploads/pdf_files/${item.pdf_file_en}`, "_blank", "noopener noreferrer")
                  ...
                  >
                    <div>
                      <span className="date text-primary">Meeting Documents</span>
