                    ...
                    >
                        ...
                        <div className="carousel-caption-1">
                            <div className="carousel-caption-1-content" style={{ maxWidth: '900px' }}>
                                ...
                                <h1 className="display-2 text-capitalize text-white mb-4">Investor Relations</h1>
                            </div>
                        </div>
                    ...
                    <img src={`${process.env.PUBLIC_URL}/assest/img/DJI.jpg`} className="img-fluid w-100" alt="Image" style={{ objectFit: 'cover', height: '100vh' }} />
                        ...
                        <div className="carousel-caption-2">
                            <div className="carousel-caption-2-content" style={{ maxWidth: '900px' }}>
                                <h1 className="display-2 text-capitalize text-white mb-4">Sign up for news</h1>
                                <p className="mb-5 fs-5 text-white">You will be the first to receive news about our company.</p>
...
<div className="container-fluid about overflow-hidden py-5">|
  ...
  <div className="about-item">
    ...
    <h4 className="text-primary text-uppercase mt-4">Financial Statements</h4>
    {financialReport && (
      <div
        className="data-item d-flex justify-content-between align-items-center"
        onClick={() =>
          window.open(financialReport.pdf_url_en, "_blank", "noopener noreferrer")
        }
        style={{
          cursor: "pointer",
          padding: "10px",
...
<h4 className="text-primary text-uppercase mt-4">Management Discussion and Analysis</h4>
{latestCard && (
  <div
    className="data-item d-flex justify-content-between align-items-center"
    onClick={() => {
      const pdfUrl = `${process.env.REACT_APP_PDF_KEY}/uploads/pdf_files/${latestCard.pdf_url_en}`; // ใช้ latestCard
...
<h4 className="text-primary text-uppercase mt-4">Presentation Documents</h4>
      {latestAnalysis && (
        <div
          className="data-item d-flex justify-content-between align-items-center"
          onClick={() => {
            const pdfUrl = `${process.env.REACT_APP_PDF_KEY}/uploads/pdf_files/${latestAnalysis.pdf_url_en}`;
        ...
        >
          <div>
            ...
            <p className="mb-0">{latestAnalysis.title_en}</p>
          </div>
          <button className="btn btn-outline-primary">
            <i className="fas fa-arrow-right"></i>
          </button>
...
<h4 className="text-primary text-uppercase mt-4">56-1 One Report</h4>
      {latestReport && (
        <div
          className="data-item d-flex justify-content-between align-items-center"
          onClick={() => {
            const pdfUrl = `${process.env.REACT_APP_PDF_KEY}/uploads/pdf_files/${latestReport.file_path_en}`;
            console.log("Opening PDF URL:", pdfUrl);
            window.open(pdfUrl, "_blank", "noopener noreferrer");
          }}
          style={{
        ...
        >
          <div>
            ...
            <p className="mb-0">{latestReport.title_en}</p>
          </div>
          <button className="btn btn-outline-primary">
            <i className="fas fa-arrow-right"></i>
          </button>
...
<div className="container-fluid feature bg-light py-5">
  <div className="container py-5">
    <div
      ...
      style={{ maxWidth: 800 }}
    >
      <h1 className="display-3 text-capitalize mb-3">News to the Stock Exchange</h1>
    </div>
        ...
        news.map((news, index) => (
          ...
          >
            ...
            >
              <div className="mb-3">
                <a
                  href={`${process.env.REACT_APP_PDF_KEY}/uploads/pdf_files/${news.pdf_url_en}`} // ใช้ URL PDF จาก API
                  target="_blank"
              ...
              <h4 className="mb-3">
  {news.title.length > 30 ? news.title.slice(0, 55) + "..." : news.title_en}
</h4>
 {/* แสดงหัวข้อข่าว */}
              <h5
                className="mb-3"
...
<div className="container-fluid service bg-light overflow-hidden py-5">
      <div className="container py-5">
        <div className="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style={{ maxWidth: 800 }}>
          <h1 className="display-3 text-capitalize mb-3">Events Calendar</h1>
        </div>
...
<div className="container-fluid contact pb-1">
    <div className="container pb-5">
      ...
      <div className="contact-info" style={{ padding: '20px' }}>
        <p style={{ textAlign: 'center'}}><strong>Thai Rung Union Car Public Company Limited</strong></p>
        <p style={{ textAlign: 'center'}}>304 Macharoen Road Nong Kang Phlu, Nong Khaem, Bangkok 10160</p>
    ...
    © Copyright 2019 Thai Rung Union Car Public Company Limited
    </p>
      </div>
    </div>
        </div>
